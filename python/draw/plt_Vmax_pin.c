...
{
	TFile *f_sim1 = new TFile("./dataout${VBIAS}V.root");
	...
	chain2->Draw("(-Vmin*1e3):((z*1e3)-11985)>>data","Vbias==-${VBIAS}");
	...
	leg1->AddEntry(h1,"${VBIAS}V_RASER");
	leg1->AddEntry(h2,"${VBIAS}V_TCT_HPK(z'=z-11985)");
	...
	leg1->Draw();
	c->Print("figure/Vmax_hpk_pin_com_TF_bv${VBIAS}.pdf");
